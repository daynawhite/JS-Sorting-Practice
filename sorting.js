...
const evens = nums.filter(makeEven)
// console.log(evens)
const evensSum = evens.reduce((acc, a) => acc + a, 0);
console.log('The sum of the even numbers in the array is ' + evensSum)
...
console.log("The number 7 is at index 505, and 505 + 7 = 512")
  ...
  const weatherStates = weather.reduce(
    (acc, current) => {
      console.log('result ' + acc);
      console.log('curr ' + current.weather_state_name);
      if (!acc.includes(current.weather_state_name)) {
        acc.push(current.weather_state_name)
      }
      return acc;
    }, 
    []
...
// console.log(weather.find(idealTemp))
let foundObj = weather.find(idealTemp)
